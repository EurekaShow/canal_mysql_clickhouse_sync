...
CANAL_OPTS="-Dloader.path=$loader_path -DappName=canal_mysql_clickhouse_sync -Dlogback.configurationFile=$logback_configurationFile"
MAIN_JAR=$base/lib/canal-mysql-clickhouse-sync-*.jar
